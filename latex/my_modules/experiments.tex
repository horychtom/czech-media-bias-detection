...
\makebox[\textwidth][c]{
  ...
  \caption{Example of the bias classifier demo usage. Red color represent biased sentence nad blue neutral.}
  \label{fig:demodemo}
  }
\end{figure}
